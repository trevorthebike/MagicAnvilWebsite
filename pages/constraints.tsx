      ...
      <main>
        ...
        <div className="memberpage">
          ...
          <section>
              ...
              <p>To make our game accessible to a broader audience, we expanded our localization efforts to include both Chinese and English languages. This involved not only translating text but also adapting various game assets and incorporating new fonts to accommodate the distinct characteristics of each language. Here's a closer look at how we achieved this:</p>
              <ul>
